...
use "C:\Users\rmjdshc\OneDrive - University College London\Temp\HSEBMI97-19.dta", clear
count
renvars, lower
generate m = sex==1 
generate f = sex==2 
...
gen age_f= inlist(year2,2015,2016,2017,2018,2019)
...
replace yearc=22 if year2==2019
...
lincom _b[c.htval@22.yearc#1.sex] - _b[c.htval@0.yearc#1.sex]      /* Men */
lincom _b[c.htval@22.yearc#2.sex] - _b[c.htval@0.yearc#2.sex]      /* Women */
*Women vs men
lincom (_b[c.htval@22.yearc#2.sex] - _b[c.htval@0.yearc#2.sex]) - (_b[c.htval@22.yearc#1.sex] - _b[c.htval@0.yearc#1.sex])
...
lincom _b[c.wtval@22.yearc#1.sex] - _b[c.wtval@0.yearc#1.sex]      /* Men */
lincom _b[c.wtval@22.yearc#2.sex] - _b[c.wtval@0.yearc#2.sex]      /* Women */
*Women vs men
lincom (_b[c.wtval@22.yearc#2.sex] - _b[c.wtval@0.yearc#2.sex]) - (_b[c.wtval@22.yearc#1.sex] - _b[c.wtval@0.yearc#1.sex])
...
lincom _b[c.bmival@22.yearc#1.sex] - _b[c.bmival@0.yearc#1.sex]       /* Men */
lincom _b[c.bmival@22.yearc#2.sex] - _b[c.bmival@0.yearc#2.sex]      /* Women */
*Women vs men
lincom (_b[c.bmival@22.yearc#2.sex] - _b[c.bmival@0.yearc#2.sex]) - (_b[c.bmival@22.yearc#1.sex] - _b[c.bmival@0.yearc#1.sex])
...
lincom _b[c.overwt@22.yearc#1.sex] - _b[c.overwt@0.yearc#1.sex]            /* Men */
lincom _b[c.overwt@22.yearc#2.sex] - _b[c.overwt@0.yearc#2.sex]            /* Women */
*Women vs men
lincom (_b[c.overwt@22.yearc#2.sex] - _b[c.overwt@0.yearc#2.sex]) - (_b[c.overwt@22.yearc#1.sex] - _b[c.overwt@0.yearc#1.sex])

*Obesity.
svy:mean obese,stdize(agegroup) stdweight(std_weight) over(sex yearc)
lincom _b[c.obese@22.yearc#1.sex] - _b[c.obese@0.yearc#1.sex]              /* Men */
lincom _b[c.obese@22.yearc#2.sex] - _b[c.obese@0.yearc#2.sex]              /* Women */
*Women vs men
lincom (_b[c.obese@22.yearc#2.sex] - _b[c.obese@0.yearc#2.sex]) - (_b[c.obese@22.yearc#1.sex] - _b[c.obese@0.yearc#1.sex])
...
lincom _b[c.wstval@22.yearc#1.sex] - _b[c.wstval@0.yearc#1.sex]      /* Men */
lincom _b[c.wstval@22.yearc#2.sex] - _b[c.wstval@0.yearc#2.sex]      /* Women */
*Women vs men
lincom (_b[c.wstval@22.yearc#2.sex] - _b[c.wstval@0.yearc#2.sex]) - (_b[c.wstval@22.yearc#1.sex] - _b[c.wstval@0.yearc#1.sex])

*Abdominal obesity.
svy,subpop(nonmissWC):mean raisedWC,stdize(agegroup) stdweight(std_weight) over(sex yearc)
lincom _b[c.raisedWC@22.yearc#1.sex] - _b[c.raisedWC@0.yearc#1.sex]       /* Men */
lincom _b[c.raisedWC@22.yearc#2.sex] - _b[c.raisedWC@0.yearc#2.sex]      /* Women */
*Women vs men
lincom (_b[c.raisedWC@22.yearc#2.sex] - _b[c.raisedWC@0.yearc#2.sex]) - (_b[c.raisedWC@22.yearc#1.sex] - _b[c.raisedWC@0.yearc#1.sex])
...
margins, at(yearc=(0 22) sex=(1) age_c=0 age_csq=0) noatlegend
margins, at(yearc=(0 22) sex=(2) age_c=0 age_csq=0) noatlegend
*change over time for men
lincom 22.yearc
*difference in change (women vs men)
lincom 22.yearc#2.sex
...
margins, at(yearc=(0 22) sex=(1 2) age_c=0 age_csq=0 bmi_c=0 bmi_csq=0) noatlegend        /*BMI = 25 */
margins, at(yearc=(0 22) sex=(1 2) age_c=0 age_csq=0 bmi_c=5 bmi_csq=25)  noatlegend      /*BMI = 30 */
margins, at(yearc=(0 22) sex=(1 2) age_c=0 age_csq=0 bmi_c=10 bmi_csq=100) noatlegend     /*BMI = 35 */

*Men
lincom 22.yearc
lincom (22.yearc) + (22.yearc#c.bmi_c)*5  + (22.yearc#c.bmi_csq)*25
lincom (22.yearc) + (22.yearc#c.bmi_c)*10  + (22.yearc#c.bmi_csq)*100
*difference in change (women vs men)
lincom 22.yearc#2.sex                                                                         /*BMI = 25 */
lincom (22.yearc#2.sex) + (22.yearc#2.sex#c.bmi_c)*5 + (22.yearc#2.sex#c.bmi_csq)*25         /*BMI = 30 */
lincom (22.yearc#2.sex) + (22.yearc#2.sex#c.bmi_c)*10 + (22.yearc#2.sex#c.bmi_csq)*100       /*BMI = 35 */
...
*difference in change (women vs men)
lincom 22.yearc#2.sex
lincom (22.yearc#2.sex) + (22.yearc#2.sex#c.bmi_c)*5 + (22.yearc#2.sex#c.bmi_csq)*25
lincom (22.yearc#2.sex) + (22.yearc#2.sex#c.bmi_c)*10 + (22.yearc#2.sex#c.bmi_csq)*100
*Women
lincom  22.yearc + 22.yearc#2.sex
lincom (22.yearc + 22.yearc#2.sex) + ((22.yearc#c.bmi_c)*5) + ((22.yearc#2.sex#c.bmi_c)*5) + ((22.yearc#c.bmi_csq)*25) + ((22.yearc#2.sex#c.bmi_csq)*25)
lincom (22.yearc + 22.yearc#2.sex) + ((22.yearc#c.bmi_c)*10) + ((22.yearc#2.sex#c.bmi_c)*10) + ((22.yearc#c.bmi_csq)*100) + ((22.yearc#2.sex#c.bmi_csq)*100)
